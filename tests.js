...
describe('add',function () {
    ...
    it('should returns 6', function () {
        expect(add("-4", "10")).toBe(6)
    });
    it('should return NaN if "banana" and "split"', function () {
        expect(add("banana", "split")).toBe(NaN)
    });
    it('should return NaN if 2 and "apples"', function () {
        expect(add(2, "apples")).toBe(NaN)
    });
    it('should return NaN if empty', function () {
        expect(add("")).toBe(NaN)
    });
})